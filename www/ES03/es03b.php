...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Recupero i dati 
        $nome = isset($_POST['nome']) ? $_POST['nome'] : 'Non fornito'; // se non è nullo prendo il nome se è nullo esce non fornito
        ...
        echo "<p><strong>Nome:</strong> $nome</p>";  // strong per stampare in grassetto
